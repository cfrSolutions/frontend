    ...
    <div className="w-full min-h-screen">
      ...
      <div className="flex items-center justify-center px-6 py-16 bg-gray-100 rounded-4xl">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          {/* RIGHT (Hover Card) */}
          <div className="phone relative mt-10 lg:left-[150px] flex justify-center mt-10 lg:mt-0 w-[300px] sm:w-[300px] md:w-[340px] lg:w-[390px] xl:w-[390px] h-[550px] sm:h-[500px] md:h-[340px] lg:h-[600px] xl:h-[600px]">
            <div className="notch"></div>
       <div className="card">
