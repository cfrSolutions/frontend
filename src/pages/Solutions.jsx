...
<div className="max-w-null rounded-2xl mb-15 mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-center bg bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 text-white">
