...
//   { label: "Project", icon: FolderOutput, to: "/superadmin/dashboard/projects" },
...
export default function SuperAdminDashboard() {
  ...
  // Check which panel is currently being used
  const isAdminPanel = location.pathname.startsWith("/admin/dashboard");

  // Base path changes automatically
  const basePath = isAdminPanel
    ? "/admin/dashboard"
      ...
      >
        ...
        <div className="flex justify-between items-center px-5 py-4 bg-white border-b border-gray-300">
          ...
          <div className="flex items-center gap-3">
            ...
            <div
              className="
                w-9 h-9 bg-green-500 text-white
